...
const zoomLevel = 12;
const foodIcon = L.icon({ iconUrl: require('../assets/teal-marker.png'), iconSize: [28, 30], iconAnchor: [15, 30],})
const eventsIcon = L.icon({ iconUrl: require('../assets/pink-marker.png'), iconSize: [28, 30], iconAnchor: [15, 30],})
const adventuresIcon = L.icon({ iconUrl: require('../assets/yellow-marker.png'), iconSize: [28, 30], iconAnchor: [15, 30],})
